...
SECRET_KEY = 'django-insecure-(%6(jnia_2r)gwra5w)sea3$(yu-_dm_hv#dl+#0x_8qpd)ww9'
...
# corey Says about he sets up EMAIL_USER and EMAIL_PASS so i do add the enviroment variables 
